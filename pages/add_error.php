...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("
        INSERT INTO errors (error_code, error_name, group_id, subgroup_id, description, province, city, station, attachment, created_by) 
        VALUES (:error_code, :error_name, :group_id, :subgroup_id, :description, :province, :city, :station, :attachment, :created_by)
    ");
    $stmt->execute([
    ...
    $stmt = $conn->prepare("
        ...
        VALUES (:error_id, :user_id, 'افزودن', 'خطا اضافه شد')
    ");
    $stmt->execute([
        'error_id' => $conn->lastInsertId(),
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="/loco/pages/add_error.php" method="post" enctype="multipart/form-data">
